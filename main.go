...
func (u User) checkin() error {
	...
	postBody.Add("formdata[m]", u.Postdata.M)
	postBody.Add("formdata[l]", u.Postdata.L)
	postBody.Add("formdata[k]", u.Postdata.K)
	postBody.Add("formdata[j]", u.Postdata.J)
	postBody.Add("formdata[i]", u.Postdata.I)
	postBody.Add("formdata[h]", u.Postdata.H)
	...
	postBody.Add("formdata[y]", u.Postdata.Y)
